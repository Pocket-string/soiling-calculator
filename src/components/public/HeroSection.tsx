  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700">
        ...
        <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-primary-500/15 rounded-full blur-3xl" />
      </div>
        ...
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-body-sm text-slate-200">
              Monitoreo de soiling fotovoltaico en {siteConfig.contact.city}, {siteConfig.contact.country}
            </span>
          </div>
          ...
          <p className="text-body-lg md:text-body-xl text-slate-200 mb-10 max-w-2xl leading-relaxed">
            {hero.subheadline}
          </p>
